var ComponentsDropdowns = function() {
	...
	var handleSelect2 = function() {
		...
		function format(state) {
			...
			return "<img class='flag' src='" + Metronic.getGlobalImgPath()
					+ "flags/" + state.id.toLowerCase() + ".png'/>&nbsp;&nbsp;"
					+ state.text;
		}
							...
							ajax : { // instead of writing the function to
								...
								data : function(term, page) {
									return {
										q : term, // search term
										page_limit : 10,
										apikey : "ju6z9mjyajq2djue3gbvv26t" // please
																			// do
																			// not
																			// use
																			// so
