			...
			<ul class="nav navbar-nav pull-right">
						...
						<li>
							<ul class="dropdown-menu-list scroller" style="height: 275px;"
								...
								<li><a href="inbox.html?a=view"> <span class="photo">
											<img
											src="${pageContext.request.contextPath}/static/layout3/img/avatar2.jpg"
								...
								<li><a href="inbox.html?a=view"> <span class="photo">
											<img
											src="${pageContext.request.contextPath}/static/layout3/img/avatar3.jpg"
											class="img-circle" alt="">
								...
								<li><a href="inbox.html?a=view"> <span class="photo">
											<img
											src="${pageContext.request.contextPath}/static/layout3/img/avatar1.jpg"
											class="img-circle" alt="">
				...
				<li class="dropdown dropdown-user"><a href="javascript:;"
					...
					data-hover="dropdown" data-close-others="true"> <img alt=""
						...
						%> <span class="username username-hide-on-mobile"> <%=firstName%>
