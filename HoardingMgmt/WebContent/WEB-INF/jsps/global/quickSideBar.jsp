							...
							<div class="page-quick-sidebar-chat-users" data-rail-color="#ddd"
								...
								<ul class="media-list list-items">
									<li class="media">
										...
										src="${pageContext.request.contextPath}/static/layout/img/avatar3.jpg"
										alt="...">
									...
									<li class="media"><img class="media-object"
										src="${pageContext.request.contextPath}/static/layout/img/avatar1.jpg"
										alt="...">
										<div class="media-body">
									...
									<li class="media">
										...
										src="${pageContext.request.contextPath}/static/layout/img/avatar4.jpg"
										alt="...">
										<div class="media-body">
									...
									<li class="media"><img class="media-object"
										src="${pageContext.request.contextPath}/static/layout/img/avatar2.jpg"
										alt="...">
										<div class="media-body">
								...
								<ul class="media-list list-items">
									<li class="media">
										...
										src="${pageContext.request.contextPath}/static/layout/img/avatar6.jpg"
										alt="...">
										<div class="media-body">
									...
									<li class="media">
										...
										src="${pageContext.request.contextPath}/static/layout/img/avatar7.jpg"
										alt="...">
										<div class="media-body">
									...
									<li class="media"><img class="media-object"
										src="${pageContext.request.contextPath}/static/layout/img/avatar8.jpg"
										alt="...">
										<div class="media-body">
									...
									<li class="media">
										...
										src="${pageContext.request.contextPath}/static/layout/img/avatar9.jpg"
										alt="...">
										<div class="media-body">
									...
									<li class="media"><img class="media-object"
										src="${pageContext.request.contextPath}/static/layout/img/avatar10.jpg"
										alt="...">
										<div class="media-body">
									...
									<li class="media">
										...
										src="${pageContext.request.contextPath}/static/layout/img/avatar11.jpg"
										alt="...">
										<div class="media-body">
