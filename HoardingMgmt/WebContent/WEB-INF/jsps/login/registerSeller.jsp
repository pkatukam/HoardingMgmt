<!-- BEGIN REGISTRATION FORM -->
		<form id ="register-seller-form" class="register-form" action="index.html" method="post">
			<h3>Sign Up</h3>
			<p class="hint">Enter your seller personal details below:</p>
			...
			<div class="form-actions">
				<button type="button" id="register-seller-back-btn" class="btn btn-default">Back</button>
