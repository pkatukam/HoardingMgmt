<!-- BEGIN REGISTRATION FORM -->
		<form id ="register-buyer-form" class="register-form" action="index.html" method="post">
			<h3>Sign Up</h3>
			<p class="hint">Enter your buyer personal details below:</p>
			...
			<div class="form-actions">
				<button type="button" id="register-buyer-back-btn" class="btn btn-default">Back</button>
